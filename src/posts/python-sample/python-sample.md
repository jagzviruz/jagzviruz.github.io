...
slug: /python-sample
date: '2020-08-07'
spoiler: sample for python code highlighting
tags: ['python', 'sample']
keywords:
---
## Using Python highlight

This is an example taken from [Python fiddle](http://pythonfiddle.com/grocery-calculator-script/)
```python
